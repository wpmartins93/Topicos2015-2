...
public class TelaJogo extends TelaBase {
    ...
    private void initSons() {
        ...
        musicaFundo = Gdx.audio.newMusic(Gdx.files.internal("sounds/fundo2.mp3"));
    ...
    private void reiniciarJogo() {
        /**
         * Verifica se o usuário pressionou ENTER para reiniciar o jogo
         */
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.ENTER)){
            ...
            //Verifica se a nova pontuação é maior que a pontuação máxima
    ...
    private void capturaTeclas() {
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.LEFT) || cliqueEsquerda()){
            indoEsquerda = true;
        }

        if (Gdx.input.isKeyPressed(Input.Keys.RIGHT) || cliqueDireita()){
            indoDireita = true;
        }
    ...
    private boolean cliqueEsquerda() {
